...
int main(void)
{
  ...
  n = 16; /** 7 'x' variables, 2 factor variables, 7 binary variables **/
 ...
 /* Create initial model */
  ...
  for(j = 0; j < n; j++){
	...
	if (j < 9) vartype[j] = GRB_CONTINUOUS;
  ...
  qval[0] = 100.0; qrow[0] = 0; qcol[0] = 0;
  qval[1] = 200.0; qrow[1] = 1; qcol[1] = 1;
  qval[2] = 300.0; qrow[2] = 2; qcol[2] = 2;
  qval[3] = 400.0; qrow[3] = 3; qcol[3] = 3;
  qval[4] = 500.0; qrow[4] = 4; qcol[4] = 4;
  qval[5] = 600.0; qrow[5] = 5; qcol[5] = 5;
  qval[6] = 700.0; qrow[6] = 6;   qcol[6] = 6;  

  qval[7] = 1000.0; qrow[7] = 7; qcol[7] = 7;							
  qval[8] = 2000.0; qrow[8] = 8; qcol[8] = 8;
  qval[9] = 10; qrow[9] = 7; qcol[9] = 8;
  qval[10] = 10; qrow[10] = 8; qcol[10] = 7;	 
  ...
  /** sum of z variables <= 3 **/
  cval[0] = 1.0; cval[1] = 1.0; cval[2] = 1.0;
  cval[3] = 1.0;  cval[4] = 1.0; cval[5] = 1.0; cval[6] = 1.0;

  for (j = 0; j < 7; j++) cind[j] = j + 9;
